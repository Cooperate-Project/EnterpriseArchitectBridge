 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getClientEnd <em>Client End</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getColor <em>Color</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getConnectorID <em>Connector ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getEndPointX <em>End Point X</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getEndPointY <em>End Point Y</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getEventFlags <em>Event Flags</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getIsLeaf <em>Is Leaf</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getIsRoot <em>Is Root</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getIsSpec <em>Is Spec</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getMetaType <em>Meta Type</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getMiscData <em>Misc Data</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getRouteStyle <em>Route Style</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getSequenceNo <em>Sequence No</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getStartPointX <em>Start Point X</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getStartPointY <em>Start Point Y</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getStateFlags <em>State Flags</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getStyleEx <em>Style Ex</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getSubtype <em>Subtype</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getSupplierEnd <em>Supplier End</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getTaggedValues <em>Tagged Values</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getTransitionAction <em>Transition Action</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getTransitionEvent <em>Transition Event</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getTransitionGuard <em>Transition Guard</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getVirtualInheritance <em>Virtual Inheritance</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
