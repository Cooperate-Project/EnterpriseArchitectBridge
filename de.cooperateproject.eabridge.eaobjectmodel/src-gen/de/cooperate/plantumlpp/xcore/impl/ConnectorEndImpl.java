 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getAggregation <em>Aggregation</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getAllowDuplicates <em>Allow Duplicates</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getContainment <em>Containment</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getDerived <em>Derived</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getDerivedUnion <em>Derived Union</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getEnd <em>End</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getElement <em>Element</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getIsChangeable <em>Is Changeable</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getIsNavigable <em>Is Navigable</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getNavigable <em>Navigable</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getOrdering <em>Ordering</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getOwnedByClassifier <em>Owned By Classifier</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getRole <em>Role</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getRoleNote <em>Role Note</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getRoleType <em>Role Type</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ConnectorEndImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 *
 * @generated
 */
