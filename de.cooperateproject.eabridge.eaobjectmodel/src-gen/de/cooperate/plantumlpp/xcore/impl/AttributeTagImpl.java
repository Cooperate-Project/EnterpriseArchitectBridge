 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeTagImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeTagImpl#getFQName <em>FQ Name</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeTagImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeTagImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeTagImpl#getTagGUID <em>Tag GUID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeTagImpl#getTagID <em>Tag ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeTagImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeTagImpl extends MinimalEObjectImpl.Container implements AttributeTag {
	...
	protected EClass eStaticClass() {
		return XcorePackage.Literals.ATTRIBUTE_TAG;
	}
	...
	public Attribute getAttribute() {
		if (eContainerFeatureID() != XcorePackage.ATTRIBUTE_TAG__ATTRIBUTE) return null;
	...
	public NotificationChain basicSetAttribute(Attribute newAttribute, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newAttribute, XcorePackage.ATTRIBUTE_TAG__ATTRIBUTE, msgs);
		return msgs;
	}
	...
	public void setAttribute(Attribute newAttribute) {
		if (newAttribute != eInternalContainer() || (eContainerFeatureID() != XcorePackage.ATTRIBUTE_TAG__ATTRIBUTE && newAttribute != null)) {
			...
			if (newAttribute != null)
				msgs = ((InternalEObject)newAttribute).eInverseAdd(this, XcorePackage.ATTRIBUTE__TAGGED_VALUES, Attribute.class, msgs);
			msgs = basicSetAttribute(newAttribute, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.ATTRIBUTE_TAG__ATTRIBUTE, newAttribute, newAttribute));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.ATTRIBUTE_TAG__NAME, oldName, name));
	}
	...
	public void setNotes(String newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.ATTRIBUTE_TAG__NOTES, oldNotes, notes));
	}
	...
	public void setTagGUID(String newTagGUID) {
		...
		tagGUID = newTagGUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.ATTRIBUTE_TAG__TAG_GUID, oldTagGUID, tagGUID));
	}
	...
	public void setTagID(Long newTagID) {
		...
		tagID = newTagID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.ATTRIBUTE_TAG__TAG_ID, oldTagID, tagID));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.ATTRIBUTE_TAG__VALUE, oldValue, value));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case XcorePackage.ATTRIBUTE_TAG__ATTRIBUTE:
				return eInternalContainer().eInverseRemove(this, XcorePackage.ATTRIBUTE__TAGGED_VALUES, Attribute.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XcorePackage.ATTRIBUTE_TAG__NOTES:
				return getNotes();
			case XcorePackage.ATTRIBUTE_TAG__TAG_GUID:
				return getTagGUID();
			case XcorePackage.ATTRIBUTE_TAG__TAG_ID:
				return getTagID();
			case XcorePackage.ATTRIBUTE_TAG__VALUE:
				return getValue();
		}
