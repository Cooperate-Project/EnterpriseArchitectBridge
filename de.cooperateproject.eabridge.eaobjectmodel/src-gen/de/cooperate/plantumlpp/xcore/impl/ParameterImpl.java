 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getClassifierID <em>Classifier ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getIsConst <em>Is Const</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getOperationID <em>Operation ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getParameterGUID <em>Parameter GUID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getStereotypeEx <em>Stereotype Ex</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getStyleEx <em>Style Ex</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ParameterImpl#getTaggedValues <em>Tagged Values</em>}</li>
 * </ul>
 *
 * @generated
 */
