 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getBatchLoad <em>Batch Load</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getBatchSave <em>Batch Save</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getCodePath <em>Code Path</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getConnectors <em>Connectors</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getDiagrams <em>Diagrams</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getElement <em>Element</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getFlags <em>Flags</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getIsControlled <em>Is Controlled</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getIsModel <em>Is Model</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getIsNamespace <em>Is Namespace</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getIsProtected <em>Is Protected</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getIsVersionControlled <em>Is Version Controlled</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getLastLoadDate <em>Last Load Date</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getLastSaveDate <em>Last Save Date</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getLogXML <em>Log XML</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getPackageID <em>Package ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getPackages <em>Packages</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getParentID <em>Parent ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getTreePos <em>Tree Pos</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getUMLVersion <em>UML Version</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getUseDTD <em>Use DTD</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.PackageImpl#getXMLPath <em>XML Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageImpl extends MinimalEObjectImpl.Container implements de.cooperate.plantumlpp.xcore.Package {
	/**
	 ...
	 * @ordered
	 */
	protected EList<de.cooperate.plantumlpp.xcore.Package> packages;
	 ...
	 * @generated
	 */
	public EList<de.cooperate.plantumlpp.xcore.Package> getPackages() {
		if (packages == null) {
			packages = new EObjectContainmentEList<de.cooperate.plantumlpp.xcore.Package>(de.cooperate.plantumlpp.xcore.Package.class, this, XcorePackage.PACKAGE__PACKAGES);
		}
		return packages;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case XcorePackage.PACKAGE__PACKAGES:
				getPackages().clear();
				getPackages().addAll((Collection<? extends de.cooperate.plantumlpp.xcore.Package>)newValue);
				return;
			case XcorePackage.PACKAGE__PARENT_ID:
