 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getActionFlags <em>Action Flags</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getAssociationClassConnectorID <em>Association Class Connector ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getBaseClasses <em>Base Classes</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getClassifierName <em>Classifier Name</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getClassifierType <em>Classifier Type</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getComplexity <em>Complexity</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getCompositeDiagram <em>Composite Diagram</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getConnectors <em>Connectors</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getDiagrams <em>Diagrams</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getDifficulty <em>Difficulty</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getEfforts <em>Efforts</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getElementGUID <em>Element GUID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getElementID <em>Element ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getEmbeddedElements <em>Embedded Elements</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getEventFlags <em>Event Flags</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getExtensionPoints <em>Extension Points</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getFiles <em>Files</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getGenFile <em>Gen File</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getGenlinks <em>Genlinks</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getGenType <em>Gen Type</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getIsActive <em>Is Active</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getIsComposite <em>Is Composite</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getIsLeaf <em>Is Leaf</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getIsNew <em>Is New</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getIsSpec <em>Is Spec</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getIssues <em>Issues</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getLocked <em>Locked</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getMetaType <em>Meta Type</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getMethods <em>Methods</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getMetrics <em>Metrics</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getMiscData <em>Misc Data</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getMultiplicity <em>Multiplicity</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getPersistence <em>Persistence</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getPhase <em>Phase</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getPropertyType <em>Property Type</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getPropertyTypeName <em>Property Type Name</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getRisks <em>Risks</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getRunState <em>Run State</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getScenarios <em>Scenarios</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getStyleEx <em>Style Ex</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getSubtype <em>Subtype</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getTablespace <em>Tablespace</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getTaggedValues <em>Tagged Values</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getTemplateParameters <em>Template Parameters</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getTests <em>Tests</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getTreePos <em>Tree Pos</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.ElementImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementImpl extends MinimalEObjectImpl.Container implements Element {
	...
	public void setPackage(de.cooperate.plantumlpp.xcore.Package newPackage) {
		if (newPackage != eInternalContainer() || (eContainerFeatureID() != XcorePackage.ELEMENT__PACKAGE && newPackage != null)) {
			...
			if (newPackage != null)
				msgs = ((InternalEObject)newPackage).eInverseAdd(this, XcorePackage.PACKAGE__ELEMENTS, de.cooperate.plantumlpp.xcore.Package.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case XcorePackage.ELEMENT__PACKAGE:
				return eInternalContainer().eInverseRemove(this, XcorePackage.PACKAGE__ELEMENTS, de.cooperate.plantumlpp.xcore.Package.class, msgs);
		}
