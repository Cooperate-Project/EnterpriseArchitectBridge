 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getAllowDuplicates <em>Allow Duplicates</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getAttributeGUID <em>Attribute GUID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getAttributeID <em>Attribute ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getContainment <em>Containment</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getIsCollection <em>Is Collection</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getIsConst <em>Is Const</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getIsDerived <em>Is Derived</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getIsID <em>Is ID</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getIsOrdered <em>Is Ordered</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getIsStatic <em>Is Static</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getLength <em>Length</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getRedefinedProperty <em>Redefined Property</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getStyleEx <em>Style Ex</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getTaggedValues <em>Tagged Values</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link de.cooperate.plantumlpp.xcore.impl.AttributeImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 *
 * @generated
 */
