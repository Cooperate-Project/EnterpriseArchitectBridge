...
public class XcoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case XcorePackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XcorePackage.ATTRIBUTE_CONSTRAINT: {
			...
			case XcorePackage.PACKAGE: {
				de.cooperate.plantumlpp.xcore.Package package_ = (de.cooperate.plantumlpp.xcore.Package)theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(de.cooperate.plantumlpp.xcore.Package object) {
		return null;
	}
