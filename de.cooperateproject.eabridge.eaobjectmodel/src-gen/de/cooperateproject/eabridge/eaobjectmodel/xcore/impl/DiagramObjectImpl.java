 ...
 * </p>
 * <ul>
 *   <li>{@link de.cooperateproject.eabridge.eaobjectmodel.xcore.impl.DiagramObjectImpl#getBottom <em>Bottom</em>}</li>
 *   <li>{@link de.cooperateproject.eabridge.eaobjectmodel.xcore.impl.DiagramObjectImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link de.cooperateproject.eabridge.eaobjectmodel.xcore.impl.DiagramObjectImpl#getElement <em>Element</em>}</li>
 *   <li>{@link de.cooperateproject.eabridge.eaobjectmodel.xcore.impl.DiagramObjectImpl#getInstanceID <em>Instance ID</em>}</li>
 *   <li>{@link de.cooperateproject.eabridge.eaobjectmodel.xcore.impl.DiagramObjectImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link de.cooperateproject.eabridge.eaobjectmodel.xcore.impl.DiagramObjectImpl#getRight <em>Right</em>}</li>
 *   <li>{@link de.cooperateproject.eabridge.eaobjectmodel.xcore.impl.DiagramObjectImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link de.cooperateproject.eabridge.eaobjectmodel.xcore.impl.DiagramObjectImpl#getObjectStyle <em>Object Style</em>}</li>
 *   <li>{@link de.cooperateproject.eabridge.eaobjectmodel.xcore.impl.DiagramObjectImpl#getTop <em>Top</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiagramObjectImpl extends MinimalEObjectImpl.Container implements DiagramObject {
	...
	protected EClass eStaticClass() {
		return XcorePackage.Literals.DIAGRAM_OBJECT;
	}
	...
	public void setBottom(Long newBottom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.DIAGRAM_OBJECT__BOTTOM, oldBottom, bottom));
	}
	...
	public Diagram getDiagram() {
		if (eContainerFeatureID() != XcorePackage.DIAGRAM_OBJECT__DIAGRAM) return null;
	...
	public NotificationChain basicSetDiagram(Diagram newDiagram, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDiagram, XcorePackage.DIAGRAM_OBJECT__DIAGRAM, msgs);
		return msgs;
	}
	...
	public void setDiagram(Diagram newDiagram) {
		if (newDiagram != eInternalContainer() || (eContainerFeatureID() != XcorePackage.DIAGRAM_OBJECT__DIAGRAM && newDiagram != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.DIAGRAM_OBJECT__DIAGRAM, newDiagram, newDiagram));
	}
	...
	public Element getElement() {
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XcorePackage.DIAGRAM_OBJECT__ELEMENT, oldElement, element));
			}
		}
		return element;
	}
	...
	public void setElement(Element newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.DIAGRAM_OBJECT__ELEMENT, oldElement, element));
	}
	...
	public void setInstanceID(Long newInstanceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.DIAGRAM_OBJECT__INSTANCE_ID, oldInstanceID, instanceID));
	}
	...
	public void setLeft(Long newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.DIAGRAM_OBJECT__LEFT, oldLeft, left));
	}
	...
	public void setRight(Long newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.DIAGRAM_OBJECT__RIGHT, oldRight, right));
	}
	...
	public void setSequence(Long newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.DIAGRAM_OBJECT__SEQUENCE, oldSequence, sequence));
	}
	...
	public void setObjectStyle(String newObjectStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.DIAGRAM_OBJECT__OBJECT_STYLE, oldObjectStyle, objectStyle));
	}
	...
	public void setTop(Long newTop) {
		...
		top = newTop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XcorePackage.DIAGRAM_OBJECT__TOP, oldTop, top));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XcorePackage.DIAGRAM_OBJECT__DIAGRAM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XcorePackage.DIAGRAM_OBJECT__BOTTOM:
				return getBottom();
			case XcorePackage.DIAGRAM_OBJECT__DIAGRAM:
				if (resolve) return getDiagram();
				return basicGetDiagram();
			case XcorePackage.DIAGRAM_OBJECT__ELEMENT:
				if (resolve) return getElement();
				return basicGetElement();
			case XcorePackage.DIAGRAM_OBJECT__INSTANCE_ID:
				return getInstanceID();
			case XcorePackage.DIAGRAM_OBJECT__LEFT:
				return getLeft();
			case XcorePackage.DIAGRAM_OBJECT__RIGHT:
				return getRight();
			case XcorePackage.DIAGRAM_OBJECT__SEQUENCE:
				return getSequence();
			case XcorePackage.DIAGRAM_OBJECT__OBJECT_STYLE:
				return getObjectStyle();
			case XcorePackage.DIAGRAM_OBJECT__TOP:
				return getTop();
		}
